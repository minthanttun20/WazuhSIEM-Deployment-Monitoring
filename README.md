...
File Integrity Monitoring (FIM): Real-time tracking of file creations and modifications in sensitive directories.

Endpoint Analysis: Monitored system startups, shutdowns, and agent connection states.

## 📸 Evidence of Success
Brute Force Alert: [Link to screenshot of your Logon Failure alert]

FIM Activation: [Link to screenshot of ossec.log showing "Real-time monitoring started"]
